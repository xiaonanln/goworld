...
func (gwc *GoWorldConnection) SendNotifyMapAttrChangeOnClient(sid uint16, clientid ClientID, entityid EntityID, path []string, key string, val interface{}) error {
	packet := gwc.packetConn.NewPacket()
...
func (gwc *GoWorldConnection) SendNotifyMapAttrDelOnClient(sid uint16, clientid ClientID, entityid EntityID, path []string, key string) error {
	packet := gwc.packetConn.NewPacket()
...
func (gwc *GoWorldConnection) SendNotifyListAttrChangeOnClient(sid uint16, clientid ClientID, entityid EntityID, path []string, index uint32, val interface{}) error {
	packet := gwc.packetConn.NewPacket()
...
func (gwc *GoWorldConnection) SendNotifyListAttrPopOnClient(sid uint16, clientid ClientID, entityid EntityID, path []string) error {
	packet := gwc.packetConn.NewPacket()
...
func (gwc *GoWorldConnection) SendNotifyListAttrAppendOnClient(sid uint16, clientid ClientID, entityid EntityID, path []string, val interface{}) error {
	packet := gwc.packetConn.NewPacket()
