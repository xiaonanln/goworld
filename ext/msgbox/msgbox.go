...
func (mbs *MsgboxService) DescribeEntityType(desc *entity.EntityTypeDesc) {
...
func RegisterService() {
	goworld.RegisterEntity(ServiceName, &MsgboxService{})
}
...
//}
//
//func (mb *Msgbox) DescribeEntityType(desc *entity.EntityTypeDesc) {
